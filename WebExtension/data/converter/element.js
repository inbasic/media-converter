...
element.custom = {
  input: {
    audio: {
      ...
      set rate (val) {
        let elem =  document.querySelector('[data-restore="custom-iar"]');
        elem.value = val;
      ...
      set channels (val) {
        let elem =  document.querySelector('[data-restore="custom-iac"]');
        elem.value = val;
        elem.dispatchEvent(new Event('change', {bubbles: true}));
      },
    },
    video: {
      ...
      set rate (val) {
        let elem =  document.querySelector('[data-restore="custom-ivr"]');
        elem.value = val;
        elem.dispatchEvent(new Event('change', {bubbles: true}));
      }
    }
  ...
  output: {
    ...
    set format (val) {
      let elem = document.querySelector('[data-restore="custom-of"]');
      elem.value = val;
      elem.dispatchEvent(new Event('change', {bubbles: true}));
    },
    audio: {
      ...
      set rate (val) {
        let elem = document.querySelector('[data-restore="custom-oab"]');
        elem.value = val;
        elem.dispatchEvent(new Event('change', {bubbles: true}));
      }
    },
    video: {
      ...
      set rate (val) {
        let elem = document.querySelector('[data-restore="custom-ovb"]');
        elem.value = val;
        elem.dispatchEvent(new Event('change', {bubbles: true}));
      },
      get tolerance () {
      ...
      set tolerance (val) {
        let elem = document.querySelector('[data-restore="custom-ovt"]');
        elem.value = val;
        elem.dispatchEvent(new Event('change', {bubbles: true}));
      },
      get size () {
        let mode = document.querySelector('[name="screen-size"]:checked').value;
        if (mode === 'predefined') {
      ...
      set size (val) {
        let elem1 = document.querySelector('[name="screen-size"]');
        elem1.checked = true;
        elem1.dispatchEvent(new Event('change', {bubbles: true}));
        let elem2 = document.querySelector('[data-restore="custom-sspi"]');
        elem2.value = val;
